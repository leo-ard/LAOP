...
public class ImageDefilementTMP extends JPanel {
    ...
    public ImageDefilementTMP() {
        ...
        sp.setMaximumSize(new Dimension((int)(screenDim.getWidth() / 2), (int)(screenDim.getHeight() / 1.5)));
        setLayout(new BorderLayout());
        add(lblPourContenirImage); //ajout du scrollpane au jpanel
        ...
        this.addMouseWheelListener(new MouseWheelListener() {
            ...
            public void mouseWheelMoved(MouseWheelEvent e) {
                ...
                if(newY < -a.getHeight() + getHeight() / 2){
                    newY = -a.getHeight() + getHeight() / 2;
                }
                ImageDefilementTMP.this.lblPourContenirImage.setBounds(0, newY, a.getWidth(), a.getHeight());
            }
        });
    }
